        ...
        if (entry.equals("1")){
            ...
            if (entry2.equals("1")){
                ...
                if (entry2.equals("2")) {
                    ...
                    if (entry3.equals("1")) {
                        System.out.println("You have choosen the Easy AI.");
                        ...
                        if (entry3.equals("2")) {
                            System.out.println("You have choosen the Medium AI.");
                            String name1 = ConsoleHelper.getInput("Please enter name for Player: ");
                            players.add(new Player(name1));
                    ...
                    //update with medium AI 
                            ...
                            if (entry3.equals("3")) {
                                System.out.println("You have choosen the Hard AI.");
                                String name1 = ConsoleHelper.getInput("Please enter name for Player: ");
                                players.add(new Player(name1));

                                String name2 = "JohnBot Infinity v2.3";
                    //replace with hard AI 
                                players.add(new BOTPlayer(name2));
